...
public class Cloud_computingPackageImpl extends EPackageImpl implements Cloud_computingPackage {
	...
	public EAttribute getInfraestructura_NombreProyecto() {
		return (EAttribute)infraestructuraEClass.getEStructuralFeatures().get(4);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getConexion_Servidor2(), this.getServidor(), null, "servidor2", null, 1, 1, Conexion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getConexion_Servidor1(), this.getServidor(), null, "servidor1", null, 1, 1, Conexion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(sistemaManejadorEEnum, SistemaManejador.FIREBASE_REALTIME_DATABASE);
