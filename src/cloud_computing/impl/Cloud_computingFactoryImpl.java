...
public class Cloud_computingFactoryImpl extends EFactoryImpl implements Cloud_computingFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case Cloud_computingPackage.PROVEEDOR: return createProveedor();
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			...
			case Cloud_computingPackage.TAMAÑO_MAQUINA:
				return createTamañoMaquinaFromString(eDataType, initialValue);
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			...
			case Cloud_computingPackage.TAMAÑO_MAQUINA:
				return convertTamañoMaquinaToString(eDataType, instanceValue);
			case Cloud_computingPackage.TIPO_BASE_DE_DATOS:
	 ...
	 * @generated
	 */
	public TamañoMaquina createTamañoMaquinaFromString(EDataType eDataType, String initialValue) {
		TamañoMaquina result = TamañoMaquina.get(initialValue);
		if (result == null) throw new IllegalArgumentException("The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'");
		return result;
	}
	 ...
	 * @generated
	 */
	public String convertTamañoMaquinaToString(EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
